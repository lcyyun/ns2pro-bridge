...
if ($Variant -eq 'ns2pro') {
    Info 'Skipping DS5 audio submodules for ns2pro variant.'
} else {
...
switch ($Variant) {
    ...
    'ns2pro' { $cmakeArgs += @('-DENABLE_NS2PRO=ON', '-DENABLE_SERIAL=ON') }
}
